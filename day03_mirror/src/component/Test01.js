...
const Test01 = () => {
    ...
    const idRef = useRef(null)//포커스 맞춰줄 때 많이 사용
    ...
    return (
        <div>
            ...
            {/* onChnageId()이면 reload된다 */}
            <br></br>
            비밀번호 : <input type="password" value={pwd} onChange={onChangePwd}></input>
            <br></br>
...
// 하지만 Ref안에 있는 값은 아무리 변경해도 컴포넌트는 다시 렌더링 되지 않는다.(F5해도 초기화 되지 않는다)
